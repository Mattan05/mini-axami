 ...
 */
final class Version20250207083759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE units CHANGE status status VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE units CHANGE status status VARCHAR(50) NOT NULL');
    }
}
